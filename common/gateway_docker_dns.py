...
class DNS:
 ...
 '16Uiu2HAmVrnDKphoVtGM7TK4YSt7MsJCsddocMD1gdWdUL4DwNwf': {'ip': '127.0.0.1',
    ...
    def get_all_nodes(self, n:int = None) -> List[str]:
        if n is not None:
            return list(self.lookup_table.keys())[:n]
